...
const cardData = [
    {
        cardTitle: "Card 1",
        cardDescription: "This is card 1",
        cardImageURL:
            "https://fastly.picsum.photos/id/808/200/200.jpg?hmac=OeCbxYuUpLdh3AWFCaO6QKu8PmNGdmBZbVOnx7Pdflk",
    },
    {
        cardTitle: "Card 2",
        cardDescription: "This is card 2",
        cardImageURL:
            "https://fastly.picsum.photos/id/906/200/200.jpg?hmac=jQ-m5xgglMRMPvZhK3539qEkxPG1FVUae6AeV_HKQfg",
    },
    {
        cardTitle: "Card 3",
        cardDescription: "This is card 3",
        cardImageURL:
            "https://fastly.picsum.photos/id/259/200/200.jpg?hmac=F9blvALDAoKm-lOnYw9g0q_RC51-6K1Msawm_dQzhIs",
    },
    {
        cardTitle: "Card 4",
        cardDescription: "This is card 4",
        cardImageURL:
            "https://fastly.picsum.photos/id/387/200/200.jpg?hmac=xAsfqp-sKuFi5HUw3VKwBRqzmG_uqFbmk3oiHTJXjq4",
    },
    {
        cardTitle: "Card 5",
        cardDescription: "This is card 5",
        cardImageURL:
...
function Content(prop) {
    ...
    return (
        <div>
            <input
                type="text"
                onChange={(e) => setToggleView(e.currentTarget.value)}
            ></input>
            {toggleView === "basic" && (
                <div>
                    <div>
                            ...
                            {cardData.map((cardData, index) => {
                                return (
                                    <Card
                                        ...
                                        imageURL={cardData.cardImageURL}
                                    ></Card>
                                );
                            })}
                        </div>
